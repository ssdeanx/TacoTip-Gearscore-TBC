...
["OPTIONS_TOOLTIP_STYLE_DESC"] = "Choose how much detail TacoTip shows by default. Hybrid styles show their compact layout by default and expand to full while Shift is held — in both the live tooltip and this preview.",
...
["OPTIONS_TOOLTIP_BORDER_THICKNESS_DESC"] = "Control how thick the tooltip border appears. Higher values create a wider, more prominent border edge. Default is 16px.",
...
["OPTIONS_PORTRAIT_ZOOM"] = "Portrait zoom",
["OPTIONS_PORTRAIT_ZOOM_DESC"] = "Controls how close the 3D portrait model appears. Higher values zoom in on the character's face.",
["OPTIONS_SHOW_HONOR_RANK"] = "Show honor rank",
["OPTIONS_SHOW_HONOR_RANK_DESC"] = "Show the player's PvP rank title (Knight, Centurion, etc.) on the tooltip.",
["OPTIONS_SHOW_ROLE_ICON"] = "Show group role icon",
["OPTIONS_SHOW_ROLE_ICON_DESC"] = "Show Tank/Healer/DPS role icons on the name line for party and raid members.",
["OPTIONS_SHOW_REALM"] = "Show realm",
...
["OPTIONS_TOOLTIP_MAX_WIDTH_DESC"] = "Set a maximum width for the tooltip. Set to 0 for no limit.",
["OPTIONS_TOOLTIP_DELAY"] = "Tooltip delay (ms)",
